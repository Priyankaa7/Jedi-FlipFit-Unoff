...
import com.flipkart.business.services.gymCustomerService;
...
public class FlipFitApplication {
	...
	public static void main(String[] args) {
		...
		gymCustomerInterface gymCustomerServ = new gymCustomerService(null);
		customerMenu = new GymFlipFitCustomerMenu(gymCustomerServ);
		adminMenu = new GymFlipFitAdminMenu();
		gymOwnerMenu = new GymFlipFitGymOwnerMenu();
		while (true) {
			...
			switch (choice) {
				...
				case 2:
					...
					break;
				case 3:
					register(scanner, Role.GYMOWNER);
					break;
				case 4:
